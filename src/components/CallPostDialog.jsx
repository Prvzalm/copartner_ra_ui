        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black bg-opacity-[40%]">
          <div className="bg-[#2E374B] rounded-lg md:w-[900px] w-[378px] md:h-[380px] h-[360px] overflow-auto p-8">
            ...
            <div className="flex flex-col gap-4 mt-4">
              <label className="flex flex-col items-center justify-center w-full h-[200px] border-2 border-dotted border-gray-400 rounded-lg cursor-pointer relative">
                <span className="text-gray-500 font-[400] md:text-[36px] text-[20px]">
                  {selectedFile ? "Change Your Content" : "Upload Your Content"}
                </span>
